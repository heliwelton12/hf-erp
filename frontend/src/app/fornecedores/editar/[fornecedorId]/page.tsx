...
export default function EditarFornecedorPage() {
  ...
  async function buscarFornecedor() {
    const resposta = await fetch(
      `http://127.0.0.1:8000/fornecedores/${fornecedorId}`
    )

    const dados: Fornecedor & { mensagem?: string } = await resposta.json()
  ...
  async function salvarFornecedor(event: React.FormEvent) {
    ...
    if (dados.mensagem === "Fornecedor atualizado com sucesso") {
      ...
      <div className="max-w-4xl mx-auto pl-24">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Atualize os dados cadastrais, contato e categoria do fornecedor.
          </p>
        </div>
